...
# Create a function that handles the correlation plot with all the validation
correlation_plot_function <- function() {
  ...
  # Check if the label count matches
...
eda_plots <- list(
  ...
  correlation_plot = correlation_plot_function,
