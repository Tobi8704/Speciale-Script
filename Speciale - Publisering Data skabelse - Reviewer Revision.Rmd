...
# mp_maindataset() does not return per416_2 (the "sustainability" sub-category of
# per416 used as an alternative outcome later, e.g. section 3.2 of the H1 analysis).
# Merge it in from the static MPDS2024a export included in the repo, keyed on the
# same identifiers manifestoR uses (country/date/party uniquely identify a manifesto).
